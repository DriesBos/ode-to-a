<template>
  <div class="svg-container">
    ...
    >
      ...
      <!-- prettier-ignore -->
      <text v-if="this.$route.name === 'index'" id="text-wrap" fill="none" stroke="currentColor" stroke-width="" font-size="1em">
        <textPath
          xlink:href="#thePath"
          method="stretch"
          spacing="auto"
          ...
          id="text-path"
        >
          YOUR ESSENCE IS YOUR PRESSENCE IS YOUR ESSENCE IS YOUR PRESSENCE IS YOUR ESSENCE IS YOUR PRESSENCE IS YOUR ESSENCE IS YOUR PRESSENCE YOUR ESSENCE IS YOUR PRESSENCE IS YOUR ESSENCE IS YOUR PRESSENCE YOUR ESSENCE IS YOUR PRESSENCE IS YOUR ESSENCE IS YOUR PRESSENCE YOUR ESSENCE IS YOUR PRESSENCE IS YOUR ESSENCE IS YOUR PRESSENCE YOUR ESSENCE IS YOUR PRESSENCE IS YOUR ESSENCE IS YOUR PRESSENCE YOUR ESSENCE IS YOUR PRESSENCE IS YOUR ESSENCE IS YOUR PRESSENCE YOUR ESSENCE IS YOUR PRESSENCE IS YOUR ESSENCE IS YOUR PRESSENCE YOUR ESSENCE IS YOUR PRESSENCE IS YOUR ESSENCE IS YOUR PRESSENCE YOUR ESSENCE IS YOUR PRESSENCE IS YOUR ESSENCE IS YOUR PRESSENCE IS YOUR ESSENCE IS YOUR PRESSENCE IS YOUR ESSENCE IS YOUR PRESSENCE YOUR ESSENCE IS YOUR PRESSENCE IS YOUR ESSENCE IS YOUR PRESSENCE YOUR ESSENCE IS YOUR PRESSENCE IS YOUR ESSENCE IS YOUR PRESSENCE YOUR ESSENCE IS YOUR PRESSENCE IS YOUR ESSENCE IS YOUR PRESSENCE YOUR ESSENCE IS YOUR PRESSENCE IS YOUR ESSENCE IS YOUR PRESSENCE YOUR ESSENCE IS YOUR PRESSENCE IS YOUR ESSENCE IS YOUR PRESSENCE YOUR ESSENCE IS YOUR PRESSENCE IS YOUR ESSENCE IS YOUR PRESSENCE YOUR ESSENCE IS YOUR PRESSENCE IS YOUR ESSENCE IS YOUR PRESSENCE
        </textPath>
      </text>
      <text
